...
from lt_comm import get_last_candle_info, get_strategy_info, get_general_positions_info, get_server_status, get_candle_history
...
def main(key):
    ...
    strategie_flag = st.sidebar.checkbox(label='Detail Strategie Information', value=True)
